Micro Measurement Display 0 (µMD0) firmware running on the Atmega328p Nano 3.0 for low performance homodyne interferometers, encoders, and other devices producing Quad A/B signals.
